    ...
    <div>
            ...
            <el-row>
                ...
                <el-col :span="20">
                    <div class="grid-content bg-purple">
                        <el-input v-model="searchModel.filmName" placeholder="电影名称"></el-input>
        ...
        <el-card>
            <el-table :data="filmManageList" stripe style="width: 100%">
                <el-table-column prop="filmId" label="#" width="110"></el-table-column>
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            <el-form :model="filmForm" :label-position="labelPosition" ref="filmFormRef" >
                ...
                <el-form-item label="电影简介" :label-width="formLabelWidth" prop="summary">
                    <el-input type="textarea" :autosize="{ minRows: 2, maxRows: 4}" placeholder="请输入电影简介"
                        maxlength="255"
                        show-word-limit
                        v-model="filmForm.filmSummary">
                    </el-input>
                </el-form-item>
    ...
    export default {
        data(){
            ...
            return {
                ...
                //     ],
                //     area: [
                //         { required: true, message: '请选择电影上映地区', trigger: 'blur' }
                //     ],
                //     category: [
                //         { required: true, message: '请选择电影风格', trigger: 'blur' }
                //     ],
                //     filmUrl: [
                //         { required: true, message: '请输入电影资源地址', trigger: 'blur' },
        ...
        methods:{
            ...
            //         this.filmForm.userName = username;
            //     } catch (error) {
            ...
            getFilmManageList(){
                filmApi.getFilmManageList(this.searchModel).then(Response =>{
                    this.filmManageList = Response.data.rows;
