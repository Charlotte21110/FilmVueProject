    ...
    <div>
        ...
        <el-card>
            ...
            <el-table :data="uploadList" stripe style="width: 100%">
                ...
                <el-table-column prop="filmName" label="电影名" width="150"></el-table-column>
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            ...
            <el-form :model="uploadForm" label-position="top">
                <el-form-item label="是否上架" label-width="80px">
                    <el-switch v-model="uploadForm.uploadStatus" active-text="精选上架" inactive-text="取消精选上架"
                        :active-value="'已上架'" :inactive-value="'未上架'">
                    </el-switch>
                </el-form-item>
            </el-form>
            <div slot="footer" class="dialog-footer">
                <el-button @click="dialogFormVisible = false">取消</el-button>
                <el-button type="primary" @click="uploadArticle(uploadForm)">确认</el-button>
            </div>
        </el-dialog>
...
import uploadApi from '@/api/articleUpload'
...
export default {
    ...
    methods: {
        ...
        uploadArticle(uploadForm) {
            uploadApi.uploadArticle(uploadForm).then(response => {
        ...
        openEditUI(uploadId) {
            ...
            uploadApi.getUploadArticleById(uploadId).then(res => {
