  ...
  <div>
    ...
    <el-card>
      ...
      <el-table :data="auditList" stripe style="width: 100%">
        ...
        <el-table-column prop="article" label="审核内容" width="180" show-overflow-tooltip>
    ...
    <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="auditArticle(auditForm)">确认</el-button>
      </div>
    </el-dialog>
...
import auditApi from '@/api/articleAuditManage'
  ...
  methods: {
    ...
    openEditUI(auditId) {
      ...
      auditApi.getAuditById(auditId).then(response => {
        ...
        this.auditForm.articleId = response.data.articleId;
      });
