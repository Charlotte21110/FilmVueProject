    ...
    <div>
        ...
        <el-card>
            ...
            <el-table :data="uploadList" stripe style="width: 100%">
                ...
                <el-table-column prop="comment" label="评论" width="200"></el-table-column>
        ...
        <el-dialog @close="clearForm" :title="title" :visible.sync="dialogFormVisible">
            ...
            <div slot="footer" class="dialog-footer">
                ...
                <el-button type="primary" @click="uploadComment(uploadForm)">确认</el-button>
            </div>
        </el-dialog>
...
import uploadApi from '@/api/commentUpload'
...
export default {
    ...
    methods: {
        uploadComment(uploadForm) {
            uploadApi.uploadComment(uploadForm).then(response => {
        ...
        openEditUI(uploadId) {
            ...
            uploadApi.getUploadCommentById(uploadId).then(res => {
